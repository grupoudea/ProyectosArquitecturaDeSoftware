...
public class ClienteController {
    ...
    public ResponseEntity<StandardResponse<List<ClienteDto>>> crearClientes(@Validated @RequestBody List<CrearClienteDto> crearClienteDtos){
        List<ClienteDto> clientesCreados = clienteFacade.crearClientes(crearClienteDtos);
